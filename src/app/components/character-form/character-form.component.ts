import { Component, OnInit, ElementRef, ViewChild, ViewChildren, Input, Output, EventEmitter } from '@angular/core';
...
export class CharacterFormComponent implements OnInit {
  ...
  refreshGeneralStats(): void {
	  this.nameBox.nativeElement.value = this.character.name;
	  this.speedBox.nativeElement.value = this.character.speed;
	  this.acBox.nativeElement.value = this.character.ac;
	  this.proficiencyBox.nativeElement.value = this.character.proficiencyBonus;
	  this.hpBox.nativeElement.value = this.character.maxHP;
	  this.strengthScoreBox.nativeElement.value = this.character.strengthScore;
	  this.dexterityScoreBox.nativeElement.value = this.character.dexterityScore;
	  this.constitutionScoreBox.nativeElement.value = this.character.constitutionScore;
	  this.intelligenceScoreBox.nativeElement.value = this.character.intelligenceScore;
	  this.wisdomScoreBox.nativeElement.value = this.character.wisdomScore;
	  this.charismaScoreBox.nativeElement.value = this.character.charismaScore;
	  this.hitDieBox.nativeElement.value = this.character.maxHitDie;
	  this.hitDieDiceBox.nativeElement.value = this.character.hitDieDice;
  }
  
  refreshSpellSlots(): void {
	  this.level1SlotsBox.nativeElement.value = this.character.maxSlots1;
	  this.level2SlotsBox.nativeElement.value = this.character.maxSlots2;
	  this.level3SlotsBox.nativeElement.value = this.character.maxSlots3;
	  this.level4SlotsBox.nativeElement.value = this.character.maxSlots4;
	  this.level5SlotsBox.nativeElement.value = this.character.maxSlots5;
	  this.level6SlotsBox.nativeElement.value = this.character.maxSlots6;
	  this.level7SlotsBox.nativeElement.value = this.character.maxSlots7;
	  this.level8SlotsBox.nativeElement.value = this.character.maxSlots8;
	  this.level9SlotsBox.nativeElement.value = this.character.maxSlots9;
  }
  ...
  addAttack(): void {
			...
			console.log(this.character.speed);
